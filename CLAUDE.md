...
Python CLI tool to bulk-manage Gmail: permanently delete old emails and clean specific categories (Promotions, Social, etc.) while preserving recent ones.
...
├── client.py     # Gmail API wrapper (list, batchDelete, batchModify, labels)
